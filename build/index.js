...
/******/ 	var hotCurrentHash = "b3b231a47f83c68119e6"; // eslint-disable-line no-unused-vars
...
// module
exports.push([module.i, "@font-face {\n    font-family: 'YS Text';\n    src: url('/build/fonts/YS Text-Regular.eot');\n    src: url('/build/fonts/YS Text-Regular.eot?#iefix') format('embedded-opentype'),\n        url('/build/fonts/YS Text-Regular.woff2') format('woff2'),\n        url('/build/fonts/YS Text-Regular.woff') format('woff'),\n        url('/build/fonts/YS Text-Regular.ttf') format('truetype'),\n        url('/build/fonts/YS Text-Regular.svg#YSText-Regular') format('svg');\n    font-weight: 400;\n    font-style: normal;\n}\n\n@font-face {\n    font-family: 'YS Text';\n    src: url('/build/fonts/YS Text-Bold.eot');\n    src: url('/build/fonts/YS Text-Bold.eot?#iefix') format('embedded-opentype'),\n        url('/build/fonts/YS Text-Bold.woff2') format('woff2'), url('/build/fonts/YS Text-Bold.woff') format('woff'),\n        url('/build/fonts/YS Text-Bold.ttf') format('truetype'),\n        url('/build/fonts/YS Text-Bold.svg#YSText-Bold') format('svg');\n    font-weight: 700;\n    font-style: normal;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ([{
    ...
    titleColor: '#576433',
    image: 'img/1.png',
    image2x: 'img/1@2x.png',
    image3x: 'img/1@3x.png',
    ...
    titleColor: '#3a2210',
    image: 'img/2.png',
    image2x: 'img/2@2x.png',
    image3x: 'img/2@3x.png',
    ...
    titleColor: '#36393e',
    image: 'img/7.png',
    image2x: 'img/7@2x.png',
    image3x: 'img/7@3x.png',
    ...
    titleColor: '#6679c1',
    image: 'img/8.png',
    image2x: 'img/8@2x.png',
    image3x: 'img/8@3x.png',
    ...
    titleColor: '#605a54',
    image: 'img/9.png',
    image2x: 'img/9@2x.png',
    image3x: 'img/9@3x.png',
    ...
    titleColor: '#303f36',
    image: 'img/10.png',
    image2x: 'img/10@2x.png',
    image3x: 'img/10@3x.png',
    size: 's'
}, {
    ...
    titleColor: '#5f4137',
    image: 'img/11.png',
    image2x: 'img/11@2x.png',
    image3x: 'img/11@3x.png',
    size: 's'
}, {
    title: 'Что такое «ПОКА» при прощании?',
    titleColor: '#535353',
    image: 'img/12.png',
    image2x: 'img/12@2x.png',
    image3x: 'img/12@3x.png',
    ...
    titleColor: '#437084',
    image: 'img/13.png',
    image2x: 'img/13@2x.png',
    image3x: 'img/13@3x.png',
    ...
    titleColor: '#937175',
    image: 'img/14.png',
    image2x: 'img/14@2x.png',
    image3x: 'img/14@3x.png',
    size: 's'
}, {
    title: 'Kendrick Lamar to Ban Photos at His Live Shows',
    titleColor: '#487eb6',
    image: 'img/15.png',
    image2x: 'img/15@2x.png',
    image3x: 'img/15@3x.png',
    size: 's'
}, {
